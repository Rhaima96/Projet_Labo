...
<div class="container-fluid">
    <div class="row">
        <div class="col text-center" style="background: #f2cc5d;padding-bottom: 13px;padding-top: 6px;">
            <h1>وثيقة المعدات المتلفة<br></h1>
        </div>
    </div>
    <div class="row">
        <div class="col d-flex justify-content-end"><a class="btn btn-primary btn-lg" role="button"
                style="background: #966525;border-radius: 23px;margin-top: 10px;margin-bottom: 13px;" href="{{route('detruits.create',  ['mat_id'=>$mat])}} ">إضافة</a></div>
    </div>
    <div class="row">
        <div class="col">
            <div class="table-responsive table-bordered">
                <table class="table table-bordered table-hover table-dark">
                    <thead>
                        <tr>
                            <th class="text-center" colspan="5">المعدات&nbsp;المتلفة<br></th>
                        </tr>
                        <tr>
                            ...
                            <th class="text-center"><strong>نوع المعدات&nbsp;المتلفة</strong><br></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="d-flex justify-content-center" style="padding-left: 1px;width: 200px;">
                                ...
                                <a class="btn btn-warning" role="button" href="{{route('detruits.edit', $mq->id)}}" style="margin-left: 9px;margin-right: 9px;"><i
                                        class="fa fa-edit" style="font-size: 24px;"></i></a></td>


                            <td class="text-center">{{$mq->resp}} </td>
                            <td class="text-center">{{$mq->qte}} {{$mq->unite}} </td>
                            <td class="text-center">{{$mq->m_detruit}} </td>
