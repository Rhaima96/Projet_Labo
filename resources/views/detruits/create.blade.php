...
<div class="contact-clean" style="background: #fde8ab;">
    <form method="post" style="text-align: right;" action="{{route('detruits.store',['mat_id'=>$mat])}} ">
        @csrf

        <div class="form-group"><input class="form-control" type="text" name="m_detruit" placeholder="اسم الأداة"
