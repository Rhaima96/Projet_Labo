...
@section('content')
        ...
        <div class="contact-clean" style="background: #fde8ab;">
            <form method="post" style="text-align: right;" action="{{route('detruits.update', $det->id, $det->mat_id)}} ">
                @csrf
                @method('PUT')
                ...
                <div class="form-group"><input class="form-control" type="text" value="{{$det->m_detruit}}" name="m_detruit" placeholder="اسم الأداة"
                        style="text-align: right;"></div>
                <div class="form-group">
                    <div class="form-row">
                        <div class="col"><input class="form-control" type="text" value="{{$det->qte}} " name="qte" placeholder="الكمية"
                                style="text-align: right;"></div>
                ...
                <div class="form-group"><input class="form-control" type="text" value="{{$det->resp}} " name="resp" placeholder="المسؤول"
                        style="text-align: right;"></div>
                        <div class="form-group"><input class="form-control" value="{{ date('Y-m-d',strtotime($det->date)) }}" type="date"
                            name="date"></div>
